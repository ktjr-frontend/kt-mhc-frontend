...
export const vehicleSeries = resource('vehicle/series/list', {}, {}, { _showLoadingStatus: true, ...commonOpts }) // 车系列表
export const vehicleColors = resource('vehicle/series/color', {}, {}, { _showLoadingStatus: true, ...commonOpts }) // 内饰外观颜色
