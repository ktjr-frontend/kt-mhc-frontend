<template lang="pug">
  section.profile
    ...
    section.mt10
      mt-cell(:class="userRealNameReadOnly ? 'readonly' : ''", is-link, @click.native="$router.push({name: 'realNameAuth'})", title="真实姓名", :value="user.name || '未提供'")
      mt-cell(:class="companyAuthReadOnly ? 'readonly' : ''", is-link, @click.native="showCompany", title="公司全称", :value="user.company.name || '未提供'")
    section.mt10
