...
var assetsPath = path.join(config.appProd.assetsRoot, config.appProd.assetsSubDirectory)
console.log
...
webpack(webpackConfig, function (err, stats) {
  ...
  var appAssetsPath = path.join(config.appProd.assetsRoot, '../..', 'kt-mhc-app/www')
